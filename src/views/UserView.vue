...
// Icons: refactored to absolute-style Vite aliases.
import IconPlus from '@/components/icons/IconPlus.vue';
// Layout & Core Components: refactored to absolute-style Vite aliases.
...
// Feature API: standardised to usersApi to resolve casing conflicts.
 ...
 * @property {UserProfile} profile - The detailed profile information.
 ...
 * @property {(user?: User) => void} open - Opens the modal instance.
 */

/**
 * @typedef {object} UserViewLogic
 * @property {import('vue').ComputedRef<User[]>} users - The reactive list of personnel.
 * @property {import('vue').Ref<boolean>} isLoading - Data synchronisation state.
 */
