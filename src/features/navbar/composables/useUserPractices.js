...
/**
 * Composable to manage the retrieval and selection of user practices.
 * Handles fetching practice associations and updating the active context.
 * @returns {object} The state and methods for practice management.
 */
